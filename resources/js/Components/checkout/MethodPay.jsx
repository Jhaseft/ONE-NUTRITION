    ...
    return (
        <div className="bg-white border border-gray-300 rounded-2xl p-6 mb-6 shadow-lg">
            ...
            <div className="mb-4">
                ...
                <div
                    className={`mt-3 border border-gray-300 rounded-xl bg-gray-50 overflow-hidden transition-all duration-500 ease-out ${method === "transfer" ? "max-h-[500px]" : "max-h-0"
                        }`}
                >
            ...
            <div className="mb-4">
                ...
                <div
                    className={`mt-3 border border-gray-300 rounded-xl bg-gray-50 text-center overflow-hidden transition-all duration-500 ease-out ${method === "qr" ? "max-h-[500px]" : "max-h-0"
                        }`}
                >
                    <div className="p-5 space-y-4">
                        <p className="text-gray-700 font-semibold text-lg flex justify-center items-center gap-2">
